...
public struct RareGuestData : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_2_0_0(); }
  public static RareGuestData GetRootAsRareGuestData(ByteBuffer _bb) { return GetRootAsRareGuestData(_bb, new RareGuestData()); }
  public static RareGuestData GetRootAsRareGuestData(ByteBuffer _bb, RareGuestData obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public RareGuestData __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<MiaoCsharp.RareGuestData> CreateRareGuestData(FlatBufferBuilder builder,
      int id = 0,
    ...
    RareGuestData.AddPrefab(builder, prefabOffset);
    RareGuestData.AddIcon(builder, iconOffset);
    RareGuestData.AddIntroduction(builder, IntroductionOffset);
    RareGuestData.AddName(builder, nameOffset);
    RareGuestData.AddId(builder, id);
    return RareGuestData.EndRareGuestData(builder);
  }

  public static void StartRareGuestData(FlatBufferBuilder builder) { builder.StartTable(5); }
  ...
  public static Offset<MiaoCsharp.RareGuestData> EndRareGuestData(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<MiaoCsharp.RareGuestData>(o);
  }
};
